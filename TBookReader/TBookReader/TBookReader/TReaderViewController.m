...
{
    NSLog(@"style:%ld",_style);
    UIPageViewController *pageViewController = _style == TReaderTransitionStylePageCur ? [[UIPageViewController alloc]init] : [[UIPageViewController alloc]initWithTransitionStyle:UIPageViewControllerTransitionStylePageCurl navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:nil];
       ...
       viewControllerAfterViewController:(UIViewController *)viewController
{
    ...
    NSInteger currentPage = curReaderVC.readerPager.pageIndex;
    _curPage = currentPage;
    NSLog(@"currentPage:%ld",_curPage);
    
    TReaderChapter *chapter = curReaderVC.readerChapter;
    NSLog(@"chapterIndex = %ld",chapter.chapterIndex);
    NSLog(@"totalPage = %ld",chapter.totalPage);
    NSLog(@"totalPage = %ld",chapter.totalPage);
